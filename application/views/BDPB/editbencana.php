...
<html lang="en">
  ...
  <!-- tutup jumbotron -->
    ...
    <div class="container">
      ...
      <div class="row">
      <div class="col-sm-12">
      <h2 class="text-center">Edit kejadian bencana</h2>
      <hr style="width: 100%">
      </div></div>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <?php echo form_open('BDPB/update')?>
           <!--  <form action="<?php echo base_url();?>tambahbencana.php" method="POST" enctype="multipart/form-data"> -->
                     <div class="form-group row">
            <label for="validationDefault01" class="col-sm-2 col-form-label">ID</label>
            <div class="col-sm-10">
              <div class="input-group">
              <div class="input-group-prepend">
                
              </div>
              <input type="text"class="form-control" aria-label="With textarea"  id="nama_bencana" name="id_bencana"  value="<?php echo $data_bencana->id_bencana?>"></input>
            </div>
          </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              id="jenis" name="jenis" required="TRUE" value="<?php echo $data_bencana->jenis?>">
                <option selected><?php echo $data_bencana->jenis?></option>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="text"class="form-control" aria-label="With textarea" required id="nama_bencana" name="nama_bencana" required="TRUE" value="<?php echo $data_bencana->nama_bencana?>"></input>
            </div>
          </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <textarea class="form-control" aria-label="With textarea"  required id="deskripsi_bencana" name="deskripsi_bencana" required="TRUE" 
              value="<?php echo $data_bencana->deskripsi_bencana?>"></textarea>
            </div>
          </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <input type="text"  class="form-control" id="lokasi_bencana" name="lokasi_bencana" class="form-control" placeholder="Masukkan alamat dengan lengkap"value="<?php echo $data_bencana->lokasi_bencana?>">
...
<div class="form-group row">
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <textarea class="form-control" aria-label="With textarea" placeholder="Masukkan jenis kebutuhan Beserta banyaknya" id="kebutuhan_lain" name="kebutuhan_lain"></textarea>
            </div>
          </div>
          </div>
    </div>
