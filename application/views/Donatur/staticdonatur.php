...
<li class="nav-item ">
        <a class="nav-link" href="<?php echo site_url('Donatur/index') ?>">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Donatur/semuabencanadonatur') ?>">Semua bencana<span class="sr-only"></a>
      </li>
        <li class="nav-item">
 ...
 <div style="padding-right:  50px;color: white; "><h6 class="display-5" style="font-size: 18px">Hai, <?php echo $user ?> !</h6></div>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="<?php echo site_url('Donatur/semuabencanadonatur')?>">Donasi</a>
    <a class="dropdown-item" href="<?php echo site_url('Login/logout') ?>">Sign out</a>
        ...
        <a class="btn btn-success" style="color: white;" href="<?php echo site_url('Donatur/semuabencanadonatur')?>" role="button">Donasi sekarang</a>
